 ...
 *
 * @param  {Express}    promise         The promise
 * @param  {Express}    promise.app     The Express server the routes should be registered for
 * @api private
 */
var registerRoutes = function(promise) {

    ////////////////
    // API routes //
    ////////////////

    promise.app.get('/api/libraries', LibrariesAPI.getLibraries);
    promise.app.get('/api/libraries/:slug', LibrariesAPI.getLibraryBySlug);
    promise.app.get('/api/search', SearchRESTAPI.getResults);
    promise.app.get('/api/search/facets', SearchRESTAPI.getFacetsForResults);
    promise.app.get('/api/search/:api', SearchRESTAPI.getResultById);
    ...
    promise.app.get('/', homeController.getContent);

    // Blog
    var blogsController = new BlogsController();
    promise.app.get('/blogs', blogsController.getContent);

    // Find a library
    var librariesController = new LibrariesController();
    promise.app.get('/find-a-library', librariesController.getContent);
    promise.app.get('/find-a-library/:id', librariesController.getLibraryDetail);

    // Find a resource
    var resourcesController = new ResourcesController();
    promise.app.get('/find-a-resource', resourcesController.getContent);
    promise.app.get('/find-a-resource/facets', resourcesController.getFacetsForResults);
    promise.app.get('/find-a-resource/:api/:id', resourcesController.getResourceDetail);

    // My account
    var accountController = new AccountController();
    promise.app.get('/my-account', accountController.getContent);

    // Using our libraries
    var usingLibrariesController = new UsingLibrariesController();
    promise.app.get('/using-our-libraries', usingLibrariesController.getContent);
    ...
    promise.app.use(errorHandler.getErrorPage);
};
