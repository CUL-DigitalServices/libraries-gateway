...
var createServer = module.exports.createServer = function(name, port) {
    ...
    var app = express();
    app.locals = {
        'searchUtil': require('../../../lib/util/search'),
    ...
    var io = require('socket.io').listen(servers[name]);
    ...
    servers[name].once('listening', function() {
        ...
        // Resolve the promise
        return deferred.resolve({'app': app, 'io': io});
    });
    ...
    servers[name].once('error', function(err) {
        ...
        // Reject the promise
        return deferred.reject({'code': 500, 'msg': 'Could not spin up server', 'err': err});
    });
 ...
 *
 * @param  {String}     name    The name of the server that needs to be shut down
 */
