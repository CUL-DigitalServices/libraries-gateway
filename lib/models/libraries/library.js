 ...
 */
exports.Library = function(id, code, name, url, type, coords, email, address, telephone, fax, web, map, opening_hours, admits, stock, special_collections, services, dbase) {
    var that = {};
    that.id = id;
    that.url = url;
    that.code = code;
