 ...
 * @param  {Parent}     see                     Object representing a parent library
 * @param  {Parent}     see_also                Object representing an affiliated library
 * @param  {String}     dbase                   The database the library uses (e.g. cambrdgedb, depfacaedb)
 * @return {Library}                            The returned library object
 */
exports.Library = function(id, code, name, url, type, coords, email, address, telephone, fax, web, map, facebook, blog, twitter, opening_hours, admits, stock, special_collections, services, see, see_also, staff, dbase) {
    var that = {};
    that.id = id;
    that.code = code;
    that.name = name;
...
/**
 * A parent model
 * This represents a link to the parent library, if any
 *
 * @param  {String}     name    The name of the library
 * @param  {String}     slug    The slugged name of the library
 * @return {Parent}             Object representing a parent library
 */
exports.Parent = function(name, slug) {
    var that = {};
    that.name = name;
    that.slug = slug;
    return that;
