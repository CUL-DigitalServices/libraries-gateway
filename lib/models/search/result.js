 ...
 * @param  {String}  series                 The series of the item
 ...
 */
exports.Result = function(id, extId, title, isbn, eisbn, issn, ssid, author, date, physicalDescription, series, note, contentType, thumbnail, link, branches) {
    var that = {};
    that.id = id;
    that.extId = extId;
    that.title = title;
