 ...
 */
exports.Result = function(id, src, extId, title, isbn, eisbn, issn, ssid, author, published, subject, series, note, contentType, thumbnail, link, branches) {
    var that = {};
    that.id = id;
    that.src = src;
    that.extId = extId;
 ...
 * A publication model
 *
 * @param  {Array}              publicationTitle (e.g. BMC Bioinformatics)
 * @param  {PublicationDate}    publicationDate
 * @param  {Array}              volume (e.g. 10)
 * @param  {Array}              issue (e.g. 1)
