 ...
 */
exports.Result = function(id, src, extId, titles, description, isbn, eisbn, issn, ssid, authors, published, subjects, series, tags, notes, contentType, thumbnails, links, branches) {
    var that = {};
    that.id = id;
    that.src = src;
    that.extId = extId;
