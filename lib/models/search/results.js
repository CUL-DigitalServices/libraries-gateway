 ...
 * @param  {Array}        facetsOverview  Collection of facets
 ...
 */
exports.Results = function(rowCount, facets, facetsOverview, items, pagination, suggestions) {
    var that = {};
    that.rowCount = rowCount;
    that.facets = facets;
    that.facetsOverview = facetsOverview;
    that.items = items;
