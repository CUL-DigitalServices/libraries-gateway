...
var createServer = module.exports.createServer = function(root, callback, attempts) {
    ...
    logger.log('Trying to spin up ' + config.app.title + ' at http://localhost:' + config.server.port);
    ...
    server.once('listening', function() {
        ...
        logger.log(config.app.title + ' started at http://localhost:' + String(config.server.port) + ' with ' + attempts + ' ' + attemptsString);
