...
var createServer = module.exports.createServer = function(callback, attempts) {
    ...
    var appLocals = {
        ...
        'crazy_egg_enabled': null
    };

    if (config.secret.analytics.google && config.secret.analytics.google.enabled === true) {
        appLocals.google_analytics_id = config.secret.analytics.google.id;
    }

    if (config.secret.analytics.crazy_egg && config.secret.analytics.crazy_egg.enabled === true) {
        appLocals.crazy_egg_enabled = true;
    }
