...
var ResourcesController = module.exports.ResourcesController = function() {
    ...
    that.getContent = function(req, res) {
        ...
        if (!_.isEmpty(req.query)) {
            ...
            // If the query parameter has been specified
                ...
                var url = config.server.protocol + '://' + config.server.host + ':' + config.server.port + '/api/search?' + reqParams.join('&');
    ...
    that.getResourceDetail = exports.getResourceDetail = function(req, res) {
        ...
        // Create the request url
        var url = config.server.protocol + '://' + config.server.host + ':' + config.server.port + '/api/search/' + api + '?id=' + id;
    ...
    that.getResultFacets = exports.getResultFacets = function(req, res) {
        ...
        // Create the request url
        var url = config.server.protocol + '://' + config.server.host + ':' + config.server.port + '/api/search/facets?facet=' + req.query.facet + '&' + data.query;
        ...
        _getResourceResults(url, function(error, response, results) {
            ...
            try {
                ...
                data.results = _.filter(results.results, function(row) {
                    return row.rawLabel === req.query.facet;
                });
