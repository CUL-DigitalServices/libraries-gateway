...
var getContent = exports.getContent = function(req, res) {
    ...
    console.log('[client/resources] getContent');
                ...
                if (!err) {
                    ...
                    if (!_.isEmpty(req.query)) {
                        ...
                        if (!req.query.q) {
                            ...
                            _renderMainTemplate(req, res, params);

                        // If the query parameter has been specified
                        } else {

                            // Fetch the results from the API
                            _getResourceResults(req.headers.host, req.query, function(error, results) {
                                if (error) {
...
var getResourceDetail = exports.getResourceDetail = function(req, res) {
    ...
    console.log('[client/resources] getResourceDetail');
 ...
 * @api private
 */
var _getResourceResults = function(host, query, callback) {

    console.log('[client/resources] _getResourceResults');
 ...
 * @api private
 */
var _renderMainTemplate  = function(req, res, params, html) {
