            ...
            try {
                ...
                try {
                    ...
                    for (var i=0; i<body.documents.length; i++) {
                        ...
                        var result = new ResultModel.Result(id, src, extId, title, isbn, eisbn, issn, ssid, author, date, physicalDescription, series, note, contentType, thumbnail, link);
                ...
                try {
                    ...
                    if (body.didYouMeanSuggestions.length) {
                        _getSuggestions(parameters, body.didYouMeanSuggestions, function(err, _suggestions) {
 ...
 * @api private
 */
var _getSuggestions = function(parameters, suggestions, callback) {
