...
var getResults = module.exports.getResults = function(isSummon, parameters, callback) {
    ...
    var queryString = ['s.ff=ContentType,or,,','s.ps=25', 's.dym=true', 's.debug=true'];
    ...
    request(options, function(err, res, body) {
        ...
        // We still want to display the results object, including a pagination object.
            ...
            try {
                ...
                var facets = _createFacets(body, callback);
 ...
 * @api private
 */
var _createFacets = function(body) {
    ...
    try {
        if (body.facetFields && body.facetFields[0]) {
            ...
            _.each(body.facetFields[0].counts, function(row) {
                ...
                var facetModel = new FacetModel.Facet(row.value, row.count);
 ...
 * @api private
 */
var _createResults = function(body) {
 ...
 * @api private
 */
var _createPagination = function(body, parameters) {
 ...
 * @param  {Object}       body                The response body
 * @param  {String}       parameters          Query parameters
 * @return {Suggestions}                      Suggestions object
 * @api private
 */
var _createSuggestions = function(body, parameters) {
