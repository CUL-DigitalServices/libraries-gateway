        ...
        if (err) {
            ...
            try {
                ...
                for (var i=0; i<body.documents.length; i++) {
                    ...
                    var result = new ResultModel.Result(id, title, isbn, eisbn, issn, ssid, author, date, physicalDescription, contentType, thumbnail);
                ...
                try {
                    ...
                    if (body.recordCount) {
                        ...
                        pagination = search.createPaginationModel(params, 0, 0, 0, 0);
                    }
