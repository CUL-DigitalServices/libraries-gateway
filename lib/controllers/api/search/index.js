...
/**
 * Function that gets resource details from a specific API implementation
 *
 * @param  {String}    identifier           The API that will be used to fetch the resource details
 * @param  {Object}    query                Object containing all the query parameters
 * @param  {Request}   req                  Request object
 * @param  {Response}  res                  Response object
 */
var getResourceDetails = exports.getResourceDetails = function(identifier, query, req, res) {

    // Function that returns the results from the API
    var returnResults = function(error, response) {

    };

    // Specify the external API
    if (identifier === 'aquabrowser') {
        getAquabrowserResults(query, returnResults);
    } else if (identifier === 'summon') {
        getSummonResults(query, returnResults);
    }
};
