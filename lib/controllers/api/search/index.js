...
var getResults = exports.getResults = function(req, res) {
    ...
    if (req.params.api) {
        ...
        if (isAquabrowser) {
            _getAquabrowserResults(query, function(response) {
                return res.send(200, {'results': {'data': response}, 'query': query});
            });
        }

        if (isSummon) {
            _getSummonResults(query, function(response) {
                return res.send(200, {'results': {'data': response}, 'query': query});
            });
        }
 ...
 * @api private
 */
var _getAquabrowserResults = function(query, callback) {
 ...
 * @api private
 */
var _getSummonResults = function(query, callback) {
