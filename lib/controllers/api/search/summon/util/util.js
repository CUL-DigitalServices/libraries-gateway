...
var getResourcePublicationData = module.exports.getResourcePublicationData = function(item) {
    try {
        ...
        var day = searchUtil.addLeadingZero(libUtil.consolidateValue(item['PublicationDate_xml'][0]['day']));
        var month = searchUtil.addLeadingZero(libUtil.consolidateValue(item['PublicationDate_xml'][0]['month']));
        var year = searchUtil.addLeadingZero(libUtil.consolidateValue(item['PublicationDate_xml'][0]['year']));
