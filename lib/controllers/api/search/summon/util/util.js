 ...
 */
var constructRequestQueryString = module.exports.constructRequestQueryString = function(_parameters, _queryString) {

    var parameters = _.clone(_parameters);
    ...
    if (parameters) {
        ...
        if (parameters['id']) {
            ...
            if (parameters['contenttype']) {
                queryString.push('s.fvf=ContentType,' + parameters['contenttype'] + ',false');
            }
