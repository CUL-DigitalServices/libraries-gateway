...
var getFacetsFromResults = module.exports.getFacetsFromResults = function(parameters, callback) {
    ...
    var options = apiUtil.constructRequestOptions(null, isDetailRequest, parameters, extraParams);
...
var getResults = module.exports.getResults = function(isSummon, parameters, callback) {
    ...
    var options = apiUtil.constructRequestOptions(null, isSummon, parameters, extraParams);
    ...
    try {
        if (body.facetFields) {
            ...
            _.each(body.facetFields, function(facetType) {
                ...
                facets.push(new FacetModel.FacetType(facetTypeLabel, facetTypeRawLabel, facetTypeAmount, more, items));
            });
        }
    } catch(error) {
        log().error(error);
