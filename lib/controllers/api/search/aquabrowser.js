...
var getResults = module.exports.getResults = function(_queryString, callback) {
    ...
    if (Util.hasParameter(_queryString, 'format')) {
        if (Util.hasParameter(_queryString, 'format') != 'all') {
