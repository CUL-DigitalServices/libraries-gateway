...
var _createResourceModel = function(isDetailRequest, record, callback) {
    ...
    try {
        ...
        // Create a publication data model
        var publicationTitle = null;
        var publicationDate = new ResultModel.PublicationDate(null, null, null, date);
        var published = new ResultModel.PublicationData(publicationTitle, publicationDate, physicalDescription, null, null);
        ...
        if (isDetailRequest) {
            _getItemAvailability(extId, function(error, branches) {
                ...
                var result = new ResultModel.Result(id, src, extId, title, isbn, null, null, null, author, published, subject, physicalDescription, series, note, contentType, thumbnail, link, branches);
