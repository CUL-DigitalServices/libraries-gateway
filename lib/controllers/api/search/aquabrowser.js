...
var _createResourceModel = function(record) {
    ...
    if (record.d) {
        ...
        thumbnail = [record.coverimageurl] || null;
    ...
    return new ResultModel.Result(id, extId, title, isbn, null, null, null, author, date, physicalDescription, contentType, thumbnail, link, branches);
};
...
var _getSuggestions = function(params, callback) {
    ...
    var url = config.constants.engines.aquabrowser.uri_suggestions + '?q=' + params.q;
