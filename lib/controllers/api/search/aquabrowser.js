...
var getResults = module.exports.getResults = function(parameters, callback) {
    ...
    //var queryString = ['maximumRecords=10'];
    var queryString = [];
    ...
    request(options, function(err, res, body) {
        if (err) {
            console.log(err);
            return callback('An error occurred while fetching Aquabrowser data (API request)');
        }
        ...
        var jsonstring = xml2js.parseString(xml, parseOpts, function(err, res) {
            if (err || !res.root) {
                return callback('An error occurred while fetching Aquabrowser data (xml parsing)');
            }
            ...
            try {
                ...
                return callback('An error occurred while fetching Aquabrowser data (facet creation)');
            }
            ...
            try {
                ...
                return callback('An error occurred while fetching Aquabrowser data (record parsing)');
            }
            ...
            try {
                ...
                return callback('An error occurred while fetching Aquabrowser data (pagination)');
            }
