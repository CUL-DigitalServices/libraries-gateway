    ...
    try {
        ...
        if (record.fields) {
            if (record.fields[0]) {
                ...
                link = record.fields[0].identifier;
                contentType = [record.fields[0].type];
                subject = record.fields[0].subject;
            } else {
                id = record.fields.id;
                link = record.fields.identifier;
                contentType = [record.fields.type];
