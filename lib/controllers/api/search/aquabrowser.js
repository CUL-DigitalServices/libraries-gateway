    ...
    try {
        ...
        if (isDetailRequest) {
            ...
            _getItemAvailability(extId, function(err, branches) {
                ...
                var result = new ResultModel.Result(id, src, extId, title, isbn, null, null, null, author, date, physicalDescription, series, note, contentType, thumbnail, link, branches);
