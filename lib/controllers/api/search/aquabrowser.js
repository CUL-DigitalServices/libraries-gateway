...
var _createResourceModel = function(record) {
    ...
    var result = new ResultModel.Result(id, title, isbn, null, null, null, author, date, physicalDescription, contentType, thumbnail, branches);
    return result;
};
...
var _getItemProperty = function(record, property, separator) {
    try {
        ...
        if (data[property]) {
            values = [];
            _.each(data[property], function(foo) {
