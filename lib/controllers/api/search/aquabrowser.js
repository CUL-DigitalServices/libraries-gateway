...
var _createResourceModel = function(isDetailRequest, record, callback) {
    try {
        ...
        var src = null;
        var extId = null;
        var titles = _getResourceTitles(record);
        var isbn = null;
        var author = _getResourceAuthors(record);
        var published = _getResourcePublicationData(record);
        var subject = null;
        var series = _getResourceSeries(record);
        var note = null;
        var contentType = null;
        var thumbnails = _getResourceThumbnails(record);
        var link = null;
        var branches = null;
        ...
        if (isDetailRequest) {
            _getItemAvailability(extId, function(error, branches) {
                if (error) {
                    log().error(error);
                }

                // Create a new model for the resource
                var result = new ResultModel.Result(id, src, extId, titles, isbn, null, null, null, author, published, subject, series, note, contentType, thumbnails, link, branches);
...
/**
 * Function that fetches the resource's author(s)
 * MARC21: df100
 *
 * @param  {Object}    record    Object containing record data
...
/**
 * Function that fetches the resource's title(s)
 * MARC21: df245
 *
 * @param  {Object}  record    Object containing record data
...
/**
 * Function that fetches the resource's publication data
 *
 * @param  {Object}           record    Object containing record data
...
/**
 * Function that fetches the resource's series
 * MARC21: df490
 *
 * @param  {Object}  record    Object containing record data
...
/**
 * Function that fetches the resource's thumbnails
 *
 * @param  {Object}  record    Object containing record data
