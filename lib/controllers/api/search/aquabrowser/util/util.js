...
var constructRequestOptions = module.exports.constructRequestOptions = function(uri, parameters, extraParams) {
    ...
    var properties = _.clone(parameters);
    ...
    if (parameters['id']) {
        ...
        // Loop the facet properties
        var refs = [];
        _.each(properties, function(value, property) {
            if (property.indexOf('ref:') > -1) {
                refs.push(property.substring(4));
            }
        });

        // Generate a querystring property for the facet references
        if (refs.length) {
            extraParams.push('ref=' + refs.join(';'));
        }
    }
 ...
 */
var generateAppliedFilterCollection = module.exports.generateAppliedFilterCollection = function(parameters) {
