 ...
 */
var constructRequestURL = module.exports.constructRequestURL = function(uri, isAquabrowser, parameters, extraParams) {
    ...
    return uri + '?' + extraParams.sort().join('&');
};
 ...
 */
var getResultFacets = module.exports.getResultFacets = function(results, parameters, callback) {
    ...
    try {
        ...
        _.each(results, function(facetType) {
            ...
            var facetTypeModel = new FacetModel.FacetType(facetTypeLabel, facetTypeRawLabel, facetTypeAmount, facets);
